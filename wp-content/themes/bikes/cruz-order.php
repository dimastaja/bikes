...
<div class="row">
  <div class="span12">
    ...
    <div class="breadcrumb clearfix" style="padding-left: 20px;">
      <span itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/store/" title="Store" itemprop="url"><span itemprop="Store">Магазин</span></a></span> 
      <span class="arrow-space">&gt;</span>
      <strong>CRUZ</strong>
    </div>
  </div>
  
  <h1 style="padding-left: 13px;">Создай свой CRUZ</h1>
...
<div class="overlayImage">
 <img id="base" class="base" src="/i/cruz-order/cruz-builder-base-no-frame.jpg">
 <img style="display: inline;" class="overlay overlay-color-0" src="/i/cruz-order/cruz-builder-color-fiesta.png">
 <img style="display: none;" class="overlay overlay-color-1" src="/i/cruz-order/cruz-builder-color-agua.png">
 <img style="display: none;" class="overlay overlay-color-2" src="/i/cruz-order/cruz-builder-color-cola.png">
 <img style="display: none;" class="overlay overlay-color-3 overlay-custom-color" src="/i/cruz-order/cruz-builder-color-custom-base.png">

 <img style="display: none;" class="overlay overlay-tire" src="/i/cruz-order/cruz-builder-tires-black.png">

 <div style="display: none;" class="overlay-rack">
    <img style="display: inline;" class="overlay overlay-color-0" src="/i/cruz-order/cruz-builder-rack-fiesta.png">
    <img style="display: none;" class="overlay overlay-color-1" src="/i/cruz-order/cruz-builder-rack-aqua.png">
    <img style="display: none;" class="overlay overlay-color-2" src="/i/cruz-order/cruz-builder-rack-cola.png">
    <img style="display: none;" class="overlay overlay-color-3 overlay-custom-color" src="/i/cruz-order/cruz-builder-rack-custom-base.png">
 </div>

 <img style="display: none;" class="overlay overlay-bags" src="/i/cruz-order/cruz-builder-bags.png">
 <img style="display: none;" class="overlay overlay-challengebag" src="/i/cruz-order/cruz-builder-bag.png">
</div>
  ...
  <div id="grid" class="yui3-g-r">    
    <div class="yui3-u-1-2" id="builder">
      <fieldset>
        ...
        <legend>Цвет</legend>
        <p>Выберите один из трех классических, или придумайте свой уникальный цвет..</p>

        
        

        <label>
          <input name="Color" value="Фиеста"  checked="checked" title="Fiesta" data-color="cc2c24" type="radio">
          <div class="square" style="background: #cc2c24"></div> Фиеста
        </label>        
        ...
        <label>
          <input name="Color" value="Аква"  title="Aqua" data-color="90b2b5" type="radio">
          <div class="square" style="background: #90b2b5"></div> Аква
        </label>        
        ...
        <label>
          <input name="Color" value="Кола" title="Cola" data-color="1f1b1900" type="radio">
          <div class="square" style="background: #1f1b19"></div> Кола
        </label>        
